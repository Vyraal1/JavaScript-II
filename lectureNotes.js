...
// console.log(calculate(16, 4, divide));
...
// The event director needs both the last name and T-Shirt size of each runner to send to the designer so that the designer can design custum race shirts for them. Combine both the last names and T-Shirt size and populate a new array called shirtsOrder.

let shirtOrder = [];
runners.forEach(runner =>
  shirtOrder.push(runner.shirt_size + " " + runner.last_name)
);
console.log(shirtOrder);

console.log(`${["wHy", "DoEs", "It", "PrInT", "tHe", "cOmMa"]}`);
let test1 = ["cause", "thats", "how", "log", "treats", "arrays"];
console.log(test1);
